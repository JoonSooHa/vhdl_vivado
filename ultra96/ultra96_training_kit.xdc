...
# ---------------------------------------------------------------------------- 
# Bank 26
set_property PACKAGE_PIN D7   [get_ports {pmod_a[1]               }];  # "D7.HD_GPIO_0"
set_property PACKAGE_PIN F8   [get_ports {pmod_a[2]               }];  # "F8.HD_GPIO_1"
set_property PACKAGE_PIN F7   [get_ports {pmod_a[3]               }];  # "F7.HD_GPIO_2"
set_property PACKAGE_PIN G7   [get_ports {pmod_a[4]               }];  # "G7.HD_GPIO_3"
set_property PACKAGE_PIN F6   [get_ports {pmod_a[7]               }];  # "F6.HD_GPIO_4"
set_property PACKAGE_PIN G5   [get_ports {pmod_a[8]               }];  # "G5.HD_GPIO_5"
set_property PACKAGE_PIN A6   [get_ports {pmod_a[9]               }];  # "A6.HD_GPIO_6"
set_property PACKAGE_PIN A7   [get_ports {pmod_a[10]              }];  # "A7.HD_GPIO_7"

set_property PACKAGE_PIN G6   [get_ports {pmod_b[1]               }];  # "G6.HD_GPIO_8"
set_property PACKAGE_PIN E6   [get_ports {pmod_b[2]               }];  # "E6.HD_GPIO_9"
set_property PACKAGE_PIN E5   [get_ports {pmod_b[3]               }];  # "E5.HD_GPIO_10"
set_property PACKAGE_PIN D6   [get_ports {pmod_b[4]               }];  # "D6.HD_GPIO_11"
set_property PACKAGE_PIN D5   [get_ports {pmod_b[7]               }];  # "D5.HD_GPIO_12"
set_property PACKAGE_PIN C7   [get_ports {pmod_b[8]               }];  # "C7.HD_GPIO_13"
set_property PACKAGE_PIN B6   [get_ports {pmod_b[9]               }];  # "B6.HD_GPIO_14"
set_property PACKAGE_PIN C5   [get_ports {pmod_b[10]              }];  # "C5.HD_GPIO_15"
