...
# ---------------------------------------------------------------------------- 
# Bank 26
set_property PACKAGE_PIN D7   [get_ports { q_out_0[0] }];  # pmod_a[1]  / "D7.HD_GPIO_0"
set_property PACKAGE_PIN F8   [get_ports { q_out_0[1] }];  # pmod_a[2]  / "F8.HD_GPIO_1"
set_property PACKAGE_PIN F7   [get_ports { q_out_0[2] }];  # pmod_a[3]  / "F7.HD_GPIO_2"
set_property PACKAGE_PIN G7   [get_ports { q_out_0[3] }];  # pmod_a[4]  / "G7.HD_GPIO_3"
set_property PACKAGE_PIN F6   [get_ports { q_out_0[4] }];  # pmod_a[7]  / "F6.HD_GPIO_4"
set_property PACKAGE_PIN G5   [get_ports { q_out_0[5] }];  # pmod_a[8]  / "G5.HD_GPIO_5"
set_property PACKAGE_PIN A6   [get_ports { q_out_0[6] }];  # pmod_a[9]  / "A6.HD_GPIO_6"
set_property PACKAGE_PIN A7   [get_ports { q_out_0[7] }];  # pmod_a[10] / "A7.HD_GPIO_7"
